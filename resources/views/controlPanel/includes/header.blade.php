<nav class="navbar navbar-expand-lg">
    <div class="container">
        ...
        <a href="{{route('controlPanel.login')}}" class="btn custom-btn d-lg-none ms-auto me-4">Login</a>
        ...
        @else
            <a href="{{ route('controlPanel.login') }}" class="btn custom-btn d-lg-block d-none">Login</a>
        @endif
    </div>
</nav>
